            ...
            <CardContent className="flex flex-col gap-5">
              <CardDescription>
                {product.nickname == 'Unlimited'
                  ...
                  : product.nickname == 'Free' &&
                    "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into ZenFlow's automation capabilities."}
              </CardDescription>
              ...
              {product.nickname == tier ? (
                <Button
                  disabled
                  variant="outline"
                  className="self-start bg-[#FFFFFF] text-black hover:bg-[#2F006B] hover:text-white "
                >
                  Active
                </Button>
              ) : (
